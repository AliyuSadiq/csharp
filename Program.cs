    ...
    class Program
    {
        ...
        // easy level method
         static void easy(){
            ...
            Console.WriteLine(month);
             int userNumber = 0;
             Console.WriteLine("guess the correct number between 1 to 10.");
             Console.WriteLine();
             for(int i = 5; i >= 0; i--){
        ...
        // medium level method
         static void medium(){
            ...
            Console.WriteLine(month);
             int userNumber = 0;
             Console.WriteLine("guess the correct number between 1 to 20.");
             Console.WriteLine();
             for(int i = 3; i >= 0; i--){
                  Console.WriteLine("guess the number:");
             userNumber = int.Parse(Console.ReadLine());
        ...
        // hard level method
         static void hard(){
            ...
            Console.WriteLine(month);
             int userNumber = 0;
             Console.WriteLine("guess the correct number between 1 to 50.");
             Console.WriteLine();
             for(int i = 2; i >= 0; i--){
                  Console.WriteLine("guess the number:");
             userNumber = int.Parse(Console.ReadLine());
